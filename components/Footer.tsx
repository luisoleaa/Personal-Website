...
import GitHubActivityGrid from "@/components/github/GitHubActivityGrid";
...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[#1e1e1e] bg-[#090909] px-6 py-10 text-[#eeeeee] sm:px-12">
      <div className="flex flex-col gap-8 sm:flex-row sm:items-center sm:gap-16">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            ...
            <p className="max-w-[34rem] text-[0.95rem] leading-6 text-[#9a9a9a]">
              Feel free to reach out about projects, internships, collaborations,
              or for any further questions you might have.
            </p>
          </div>
        ...
        {/* Right: GitHub activity grid */}
        <a
          href="https://github.com/luisoleaa"
          target="_blank"
          rel="noopener noreferrer"
          className="block w-fit shrink-0 text-inherit no-underline transition-opacity hover:opacity-80 sm:ml-16"
        >
          <GitHubActivityGrid />
        </a>
      </div>
